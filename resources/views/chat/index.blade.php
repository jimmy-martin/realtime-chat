...
<div class="flex flex-col h-screen w-screen bg-white">
    ...
    <div class="flex flex-row  items-center  bottom-0 my-2 w-full">
        ...
        <div class="ml-3 mr-2 flex flex-row border-gray items-center border rounded-3xl h-12 px-2">
            <input type="text" id="nickname" class="border rounded-2xl border-transparent w-full focus:outline-none text-sm h-10 flex items-center" placeholder="Votre pseudo....">
